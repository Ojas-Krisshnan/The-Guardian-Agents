...
def diagnose(
    ...
    if call is not None and settings is not None and budget is not None and getattr(settings, "api_key", None):
        try:
            ...
            # On provider error, timeout, or schema failure, fall back to deterministic domain stub
            pass
