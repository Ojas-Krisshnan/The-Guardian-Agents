      ...
      {authMode === 'register' ? (
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              <input
                ...
                style={{ width: '100%', padding: '0.6rem 2.5rem 0.6rem 0.6rem', background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 'var(--radius-sm)', color: '#fff' }}
              />
              <button
                type="button"
                ...
                onFocus={(e) => { e.currentTarget.style.boxShadow = '0 0 0 2px var(--primary)'; e.currentTarget.style.color = '#fff'; }}
                onBlur={(e) => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.color = 'var(--text-secondary)'; }}
              >
        ...
        <form
          onSubmit={async (e) => {
            ...
            setAuthError(null);
            try {
              const resp = await api.login({ username: studentUserInput.trim(), password: studentPassInput });
              handleAuthSuccess(resp);
            } catch (err: any) {
        ...
        >
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              <input
                ...
                style={{ width: '100%', padding: '0.65rem 2.5rem 0.65rem 0.65rem', background: 'rgba(0,0,0,0.4)', border: '1px solid rgba(255,255,255,0.15)', borderRadius: 'var(--radius-sm)', color: '#fff' }}
              />
              <button
                type="button"
                aria-label={showStudentPassword ? 'Hide password' : 'Show password'}
                onClick={() => setShowStudentPassword((p) => !p)}
                style={{
                  position: 'absolute',
                  right: '0.5rem',
                  top: '50%',
                ...
                onFocus={(e) => { e.currentTarget.style.boxShadow = '0 0 0 2px var(--accent-cyan)'; e.currentTarget.style.color = '#fff'; }}
                onBlur={(e) => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.color = 'var(--text-secondary)'; }}
              >
          ...
          >
            {authLoading ? <Loader2 size={16} className="animate-spin" /> : 'Sign In as Student'}
          </button>
        </form>
      ) : (
        /* Teacher Login Form */
          ...
          <div>
            ...
            <div style={{ position: 'relative', display: 'flex', alignItems: 'center' }}>
              ...
              <button
                ...
                onFocus={(e) => { e.currentTarget.style.boxShadow = '0 0 0 2px var(--accent-purple-light)'; e.currentTarget.style.color = '#fff'; }}
                onBlur={(e) => { e.currentTarget.style.boxShadow = 'none'; e.currentTarget.style.color = 'var(--text-secondary)'; }}
              >
