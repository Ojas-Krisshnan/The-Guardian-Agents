      ...
      <div className="glass-card" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '0.85rem' }}>
            ...
            <div>
              <h3 style={{ fontSize: '1.05rem', fontWeight: 700, color: '#fff' }}>
                Classroom Teacher Connection
              </h3>
              <p style={{ fontSize: '0.82rem', color: 'var(--text-secondary)' }}>
                {connectedTeachers.length > 0
                  ? 'Your account is linked to your educator. You have access to active classroom assessments and curriculum diagnostics.'
                  : 'Connect to your educator using their 6-character code (e.g. SYN-XXXXXX) to receive unit assessments.'}
              </p>
            </div>
          </div>
          ...
          <form onSubmit={handleConnectTeacher} style={{ display: 'flex', alignItems: 'center', gap: '0.5rem', flexWrap: 'wrap' }}>
            ...
            >
              {connectingTeacher ? 'Connecting...' : 'Connect Teacher'}
            </button>
          </form>
        </div>
          ...
          <div className="grid-3">
            {assignedAssessments.length === 0 ? (
              <div className="glass-card" style={{ gridColumn: '1 / -1', padding: '3rem', textAlign: 'center', color: 'var(--text-muted)' }}>
                No published assessments available in your classroom right now. When your teacher publishes an assessment, it will appear here.
              </div>
            ) : (
